...
function pwshutils {
    subl "D:\Utils\Windows-Dotfiles\dotfiles\.pwsh\src\functions\utils.ps1"
}

function pwshwsl {
    subl "D:\Utils\Windows-Dotfiles\.pwsh\src\functions\wsl.ps1"
}

function starconfig {
    subl "D:\Utils\Windows-Dotfiles\symlinks\starship\config.toml"
}

function wezconfig {
    subl "D:\Utils\Windows-Dotfiles\symlinks\wezterm\config.lua"
}

function glazeconfig {
    subl "D:\Utils\Windows-Dotfiles\symlinks\glazewm\config.yaml"
}
